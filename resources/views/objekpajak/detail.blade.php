...
@section("head_title", "Detail Titik Sumur")
@section("title")
        ...
        <div class="col-12">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">  
                        <h4 class="header-title">Detail Titik Sumur </h4>
                        </div>
                        <div class="col-6">  
                        </div>
                    </div>
                    ...
                    <form action="{{ route('objekpajak.update', ['objekpajak' => $objekpajak->op_id]) }}" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="ext : PDAM Kota Sukabumi" value="{{ $objekpajak->op_nama }}" name="op_nama" id="example-text-input" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="Format : 00.00.0.00000000.00.00" value="{{ $objekpajak->nomor_ipat }}" name='nomor_ipat' id="example-text-input" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <select name="wp_id" id="input-name" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <select name="kriteria_id" id="input-name" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <select name="harga_id" id="input-name" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <select name="kelompok_id" id="input-name" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <select name="kelurahan_id" id="input-name" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <select name="status_meteran" id="input-name" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="Zunitsu" value="{{$objekpajak->mesin_merk}}" name='mesin_merk' id="example-text-input" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="Kapasitas Minimal (Qmin) Pada Pompa" value="{{$objekpajak->kapasitas_minimal}}"  name='kapasitas_minimal' id="example-text-input" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="Kapasitas Minimal (Qmaks) Pada Pompa" value="{{$objekpajak->kapasitas_maksimal}}" name='kapasitas_maksimal' id="example-text-input" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" type="text" name='op_alamat' id="example-text-input" readonly>{{$objekpajak->op_alamat}}</textarea>
                            </div>
                        </div>
