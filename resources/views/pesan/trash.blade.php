                    ...
                    <div class="col-12">
                        <div class="email-leftbar card">
                            ...
                            <div class="mail-list m-t-20">
                                ...
                                <a href="{{route('trash')}}" class="active">Sampah  <span class="ml-1">({{$sampah}})</span></a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <div class="text-center">
                                                    <a href="{{route('everdelete' , $data->pesan_id )}}"  class="btn btn-danger waves-effect waves-light">
