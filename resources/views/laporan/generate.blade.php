                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr> 
                                            <td>2</td>
                                            <td class="text-center">{{$nilai2}} M<sup>3</td>
                                        ...
                                        <tr> 
                                            <td>3</td>
                                            <td class="text-center">{{$nilai3}} M<sup>3</td>
                                        ...
                                        <tr> 
                                            <td>4</td>
                                            <td class="text-center">{{$nilai4}} M<sup>3</td>
                                        ...
                                        <tr> 
                                            <td>5</td>
                                            <td class="text-center">{{$nilai5}} M<sup>3</td>
                                        ...
                                        <tr>
                                            <td class="no-line">*</td>
                                            <td class="no-line text-center"> <strong> {{$volume}} M<sup>3 </strong></td>
                                            <td class="no-line"></td>
                                            <td class="no-line"></td>
                            ...
                            <div class="">
                                ...
                                <div class="d-print-none">
                                    <div class="float-right">
                                        ...
                                        <a href="{{route('laporan.nmtagihan' , [$op_id , $total , $pajak , $volume ,$wp_id] )}}" class="btn btn-primary waves-effect waves-light">Simpan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
