                          ...
                          <thead>
                           ...
                           <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <div class="text-center">
                                      <a href="{{route('laporan.generate' , $data->op_id )}}"  class="btn btn-success waves-effect waves-light" >
                                       <i class="mdi mdi-checkbox-marked-outline"></i>Generate
                                    </a>
                            ...
                            <tr class='text-center'>
                                <td colspan="7">Sudah Generate Semua</td>
                            </tr>
                            @endforelse
                            </tbody>
                        </table>
